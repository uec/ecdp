...
public class QCPlots extends Composite {
	...
	{
		final ArrayList<LinkedHashMap<String,String>> sortedFiles = (ArrayList<LinkedHashMap<String, String>>) sample.sampleFlowcells.get(flowcellSerial).fileList.clone();
